...
export default function RentalContent() {
  ...
  const windows = [
    {
      n: '01',
      kicker: t(ui.rentalPanel1Kicker),
      title: t(ui.rentalPanel1Title),
      desc: t(ui.rentalPanel1Desc),
    ...
    {
      n: '02',
      kicker: t(ui.rentalPanel2Kicker),
      title: t(ui.rentalPanel2Title),
      desc: t(ui.rentalPanel2Desc),
    ...
    <SmoothScroll>
      ...
      <main style={{ background: studio.colors.bg, paddingTop: '70px', paddingBottom: isMobile ? '7rem' : '4rem' }}>
        ...
        <section style={{ maxWidth: '800px', margin: '0 auto', padding: isMobile ? '3rem 1.5rem 2rem' : '5rem 2rem 3rem', textAlign: 'center' }}>
          <Link href="/#rental" style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.72rem', fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: studio.colors.gray, textDecoration: 'none', display: 'inline-block', marginBottom: '2.5rem' }}>{t(ui.backHome)}</Link>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.72rem', fontWeight: 500, letterSpacing: '0.3em', textTransform: 'uppercase', color: studio.colors.primary, marginBottom: '1rem' }}>{t(ui.rentalLabelLv)}</p>
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(3rem, 8vw, 6rem)', letterSpacing: '0.05em', color: studio.colors.text, lineHeight: 0.95, marginBottom: '1.5rem', fontWeight: 400 }}>
            {t(ui.rentalTitle1)} <span style={{ color: studio.colors.primary }}>{t(ui.rentalTitle2)}</span>
          </h1>
            ...
            <FadeIn>
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '2rem' : '4rem', alignItems: 'center' }}>
                ...
                <div style={{ order: isMobile ? 2 : (w.reverse ? 1 : 2) }}>
                  ...
                  <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.8rem, 3.2vw, 3rem)', letterSpacing: '0.05em', color: studio.colors.text, lineHeight: 1.05, marginBottom: '1.2rem', fontWeight: 400 }}>{w.title}</h2>
        ...
        <section style={{ maxWidth: '700px', margin: '3rem auto 0', padding: isMobile ? '3rem 1.5rem' : '5rem 2rem', textAlign: 'center', borderTop: '1px solid rgba(44,36,32,0.08)' }}>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '0.72rem', fontWeight: 500, letterSpacing: '0.3em', textTransform: 'uppercase', color: studio.colors.primary, marginBottom: '1rem' }}>{t(ui.inquire)}</p>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '0.06em', color: studio.colors.text, lineHeight: 1, marginBottom: '1.5rem', fontWeight: 400 }}>
            {t(ui.bookSpace1)} <span style={{ color: studio.colors.primary }}>{t(ui.bookSpace2)}</span>
          </h2>
